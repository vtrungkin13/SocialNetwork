            ...
            <div class="flex justify-center">
                <form class="mt-32 flex flex-col justify-center rounded-xl sm:border border-gray-200 bg-white p-8" action="signup" method="post">
                    ...
                    <div class="mt-2 border border-gray-300 bg-gray-50">
                        <input class="w-56 pl-1 p-1 bg-gray-50 focus:outline-none" 
                    ...
                    <div class="mt-2 border border-gray-300 bg-gray-50">
                        <input class="w-56 pl-1 p-1 bg-gray-50 focus:outline-none" 
                               pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" 
                               title="Must contain at least one  number and one uppercase and lowercase letter, and at least 8 or more characters" 
                               type="password" name="repass" placeholder="Retype Password" required >
                    </div>
                    <div class="mt-2 border border-gray-300 bg-gray-50">
                        <input class="w-56 pl-1 p-1 bg-gray-50 focus:outline-none" 
                    ...
                    <div class="mt-2 border border-gray-300 bg-gray-50">
                        <input class="w-56 pl-1 p-1 bg-gray-50 focus:outline-none w-56" 
                               type="date" name="dob" required pattern="\d{2}-\d{2}-\d{4}" required >
                    </div>
                    <div class="flex justify-center">
                        <div class="m-1">
