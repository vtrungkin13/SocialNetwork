            ...
            <div class="relative flex justify-start 2xl:mx-96 xl:mx-72 bg-white rounded-xl sm:border border-gray-200 sm:shadow-md">
                ...
                <form class="text-sm sm:text-base p-4 sm:pl-10" action="edit" method="post" enctype="multipart/form-data">
                    ...
                    <div class="w-full sm:flex items-center py-2 sm:py-3">
                        ...
                        <input class="  pl-2 pr-2 pt-0.5 pb-0.5 bg-gray-100 focus:bg-white rounded-md autofocus" type="text" name="name" value="${sessionScope.user.name}" placeholder="Name" >
                    </div>
                    <div class="w-full sm:flex items-center py-2 sm:py-3">
                        <div class="w-28 mb-1 sm:mr-4 sm:mb-0 font-bold">
                            <p class="sm:float-right">Username</p>
                        </div>
                        <input class=" pl-2 pr-2 pt-0.5 pb-0.5 bg-gray-100 focus:bg-white rounded-md" type="text" name="username" value="${sessionScope.user.username}" placeholder="Username">
                    </div>
                    ...
                    <div class="w-full sm:flex items-center py-2 sm:py-3">
                        ...
                        <input class=" pl-2 pr-2 pt-0.5 pb-0.5 bg-gray-100 focus:bg-white rounded-md" type="date" name="dob" value="${sessionScope.user.dob}" placeholder="Dob">
                    </div>
                    <div class="w-full sm:flex items-center py-2 sm:py-3">
                        <div class="w-28 mb-1 sm:mr-4 sm:mb-0 font-bold">
