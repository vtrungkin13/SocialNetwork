...
<body>
    ...
    <div class="fixed top-0 left-0 right-0 z-40 bg-white">
      ...
      <div id="subnav-newpost" class="fixed z-50 h-screen w-screen bg-gray-500 bg-opacity-80" style="visibility: hidden;">
        <div id="subnav-newpost-container" class="fixed rounded-3xl bg-white opacity-100" style="width: 600px; height: 800px;top: 50%;left: 50%;margin-top: -400px;margin-left: -300px;">
          <div id="newpost-close" class="absolute top-0 mt-1 right-4 text-4xl cursor-pointer opacity-60 hover:opacity-100">x</div>
          ...
          <div class="flex justify-center">
            <textarea class="mt-6 rounded-md p-3 shadow-md shadow-gray-400 border border-gray-400" name="" id="" cols="60" rows="4" placeholder="What's in your mine"> </textarea>
          </div>
          <div class="flex justify-center">
            <button class="mt-2 rounded-lg bg-blue-400 px-8 pb-2 pt-1 text-xl font-bold hover:bg-blue-500 text-white">Post</button>
          </div>
        </div>
      </div>
      <!-- Container -->
