...
<html lang="en">
    ...
    <div class="fixed top-0 left-0 right-0 z-40 bg-gradient-to-b from-blue-400 to-cyan-400">
      <div class="flex items-center justify-between sm:py-1">
        ...
        <div class="hidden md:flex relative">
          ...
          <div id="subnav-search" style="visibility: hidden;" class="absolute top-8 w-80 bg-white h-96 rounded-xl cursor-pointer overflow-y-scroll">
              <a href="#" style="display:none;" class="search-item flex justify-start items-center p-2 hover:bg-gray-100 rounded-t-xl">
        ...
        <div class="mr-2 flex items-center text-3xl sm:mr-4 sm:text-4xl">
            <!-- Search Icon  -->     
          <a id="icon-search" href="#" class="md:hidden">
            <i class="ri-search-line mr-2 text-2xl text-white font-bold sm:text-3xl sm:mr-4"></i>
          </a>
    ...
    <div id="subnav-newpost" class="fixed z-50 h-screen w-screen bg-cyan-100 bg-opacity-80" style="visibility: hidden;" >
      <div class="mt-20 flex flex-col items-center justify-center">
        <div class="newpost-item relative w-80 rounded-t-xl border border-gray-300 bg-white sm:w-96">
          <p class="flex justify-center p-1 text-xl font-bold sm:p-2">Create New Post</p>
        ...
        <form class="newpost-item relative border border-gray-300 bg-white pb-12" action="">
          ...
          <button class="absolute bottom-2 right-32 rounded-lg border border-gray-300 bg-blue-400 py-1 px-4 opacity-90 hover:opacity-100 sm:right-40">Post</button>
        </form>
      </div>
    </div>
    <!-- Container -->
      ...
      <div class="mx-auto flex w-full flex-col md:w-3/5 xl:w-2/5">
        ...
        <div class="flex justify-start overflow-x-hidden bg-white p-1 sm:rounded-md sm:border sm:border-gray-300 sm:p-2">
          <div class="mr-2 min-w-fit">
            <div class="icon-story cursor-pointer rounded-full bg-gradient-to-br from-blue-500 to-cyan-500 p-0.5 shadow-sm shadow-gray-400 ">
            ...
            <div class="border border-gray-300 bg-white sm:rounded-md">
              ...
              <div class="flex justify-between">
                <div class="flex justify-between">
                  ...
                  <svg class="heart-icon mt-1 mr-2 ml-2 w-7 cursor-pointer sm:w-10" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                  ...
                  <svg class="mt-1 mr-2 ml-2 w-7 cursor-pointer sm:w-10" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                    <path fill="none" d="M0 0h24v24H0z" />
                    <path d="M10 3h4a8 8 0 1 1 0 16v3.5c-5-2-12-5-12-11.5a8 8 0 0 1 8-8zm2 14h2a6 6 0 1 0 0-12h-4a6 6 0 0 0-6 6c0 3.61 2.462 5.966 8 8.48V 17z" fill="rgba(50,152,219,1)" />
                  </svg>
                  <svg class="mt-1 mr-2 ml-2 w-7 cursor-pointer sm:w-10" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                    <path fill="none" d="M0 0h24v24H0z" />
                    <path
                ...
                <svg class="save-icon mt-1 mr-2 w-6 cursor-pointer sm:w-10" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                  <path fill="none" d="M0 0h24v24H0z" />
                ...
                <div class="relative flex justify-between border-gray-300 p-2 sm:border-t sm:p-4">
                  <div class="flex items-center">
                    ...
                    <form class="" action="comment">
                      ...
                      <button class="absolute top-0 right-2 rounded-lg bg-cyan-300 py-1 px-2 font-bold opacity-80 hover:opacity-100 sm:top-5 sm:right-4 sm:px-4">Post</button>
                    </form>
                  </div>
                </div>
              </div>
  ...
  <script>
    ...
    // Search
    var searchIconHandler = document.getElementById("search-icon")
    ...
    searchInputHandler.addEventListener("input",function(e) {
      if(e.target.value != "") {
        ...
        if(itemUserHandler[i].innerHTML.toLowerCase().includes(e.target.value.toLowerCase())) {
          subnavSearchHandler.style.visibility = "visible";
          searchItemHandler[i].style.display ="block";
        }
        }
      }
      else {
