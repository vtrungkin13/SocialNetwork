  ...
  <body>
    ...
    <div class="fixed top-0 left-0 right-0 z-40 bg-white">
      <div class="flex w-full sm:justify-center justify-between items-center pt-1 pl-4 pr-4 text-2xl sm:border-b sm:pb-1 sm:pt-1 sm:text-2xl">
        ...
        <div class="sm:flex hidden">
          <input class="bg-gray-200 p-1 pl-4 rounded-lg text-sm focus:outline-none 2xl:ml-60 xl:ml-44 sm:ml-28" type="text" placeholder="Seach..." >
        </div>
        ...
        <div class="relative 2xl:ml-60 xl:ml-44 sm:ml-28 flex items-center">
          ...
          <div>
            ...
            <div id="subnav" class=" fixed mt-1 top-10 2xl:right-96 2xl:mr-40 xl:right-80 sm:right-40 right-2 h-40 w-48 bg-gray-100 text-xl rounded-lg" style="visibility:hidden;">
              ...
              <div class="cursor-pointer pl-5 pt-1 pb-2 hover:bg-gray-200 hover:rounded-lg">Log out</div>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="sm:bg-gray-50 pt-10 sm:pt-14">
      ...
      <div class="mx-auto flex w-full flex-col sm:w-3/5 lg:w-2/5">
        <div class="mt-4 border-b border-gray-100 bg-white pb-1 sm:mb-1 sm:rounded-lg sm:border sm:border-gray-300 sm:pt-4 sm:pl-3 sm:pb-4">
          <ul class="ml-2 flex space-x-2 overflow-x-scroll">
            ...
            <li class="flex flex-col items-center space-y-1 min-w-fit">
              <div class="relative rounded-full bg-gradient-to-br from-red-500 to-yellow-500 p-1">
                <a class="block rounded-full bg-white p-1" href="#">
                  <img class="h-12 w-12 rounded-full transition hover:-rotate-2" src="https://play-lh.googleusercontent.com/XVHP0sBKrRJYZq_dB1RalwSmx5TcYYRRfYMFO18jgNAnxHAIA1osxM55XHYTb3LpkV8" alt="cute cat" />
                </a>
                <button class="add-story-btn absolute bottom-0 right-0 flex h-6 w-6 items-center justify-center rounded-full border-4 border-white bg-blue-500 font-semibold text-white hover:bg-blue-700">+</button>
              </div>
