    ...
    <body>
        ...
        <div class="-z-10 min-h-screen bg-gray-50">
            <div class="2xl:mx-80 xl:mx-52 sm:mx-12 pt-12 sm:pt-20">
                <div class="mt-4">
                    <img id="avatar" class="float-left h-20 w-20 sm:h-40 sm:w-40 mx-6 sm:mx-12 rounded-full cursor-pointer" src="avatar/${requestScope.userSearch.avatar}" alt="" />
                    <div class="">
                        ...
                        <div class="ml-32 mb-2 sm:mb-6">
                            <p class=" text-sm sm:text-xl font-bold" >${requestScope.userSearch.name}</p>
                            <p class=" text-xs sm:text-base">${requestScope.userSearch.bio}</p>
                        </div>
                    </div>
                </div>
